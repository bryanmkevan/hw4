---
title: "PhysicalActivityRecog_Blog"
author: "Suneeta Godbole"
date: "3/15/2019"
output: html_document
---

# Reproducing the Physical Activity Recognition from Smartphone data Blog
...
## Get data from UCI site and unzip to data folder
```{bash}
wget "http://archive.ics.uci.edu/ml/machine-learning-databases/00341/HAPT Data Set.zip"
mkdir data
unzip "HAPT Data Set.zip" -d "data"
```
...
Explore data - visualize activity data
```{r}
allObservations %>% 
...
Visualize Activities of acceleration and gyroscopic vectors for each Activity
```{r}
...
```
Padding Observations, create tensor data and one-hot coding of activity classes
```{r}
...
# Modification to Model Architecture and re-run of model
...
summary(model)
```
Changing number of filters to 36, reduced the accuracy of the validation. 
Adding another convolution layer, reduced the accuracy of the validation.
Adding another spatial dropout layer, reducted the accuracy of the validation. 
