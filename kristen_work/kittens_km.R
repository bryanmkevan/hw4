...
term = "pizza"
#system(paste0("rm /home/kristenmae/biostat-m280-2019-winter/hw4/kristen_work/kittens/images/*"))
## need whole path to make this work
stats_out <- get_stats(term, outPath = "/home/kristenmae/biostat-m280-2019-winter/hw4/kristen_work/kittens/images")
...
term = "sandwich"
#system(paste0("rm /home/kristenmae/biostat-m280-2019-winter/hw4/kristen_work/sandwich/images/*"))
## need whole path to make this work
stats_out <- get_stats(term, outPath = "/home/kristenmae/biostat-m280-2019-winter/hw4/kristen_work/sandwich/images")

## cookies also don't work ##

term = "chocolate+chip+cookie"
#system(paste0("rm /home/kristenmae/biostat-m280-2019-winter/hw4/kristen_work/cookie/images/*"))
## need whole path to make this work
stats_out <- get_stats(term, outPath = "/home/kristenmae/biostat-m280-2019-winter/hw4/kristen_work/cookies/images")

## bagel works at 45% ##
term = "bagel"
## need whole path to make this work
stats_out <- get_stats(term, outPath = "/home/kristenmae/biostat-m280-2019-winter/hw4/kristen_work/bagel/images")
